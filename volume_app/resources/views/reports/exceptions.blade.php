...
<div class="max-w-7xl mx-auto px-4">
    <div class="flex justify-between items-center mb-2">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('reports.exceptions', ['start_date' => request('start_date'), 'end_date' => request('end_date'), 'format' => 'pdf']) }}" class="px-4 py-2 bg-red-600 text-white rounded-lg text-sm hover:bg-red-700">Exportar PDF</a>
            <a href="{{ route('reports.exceptions', ['start_date' => request('start_date'), 'end_date' => request('end_date'), 'format' => 'csv']) }}" class="px-4 py-2 bg-green-600 text-white rounded-lg text-sm hover:bg-green-700">Exportar CSV</a>
        </div>
    </div>
